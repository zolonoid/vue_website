<template>
    <div class="footer">
        ...
        <div class="footer__pages">
            <h1 class="footer__pages-title">Pages</h1>
            <router-link class="footer__pages-link" to="/">Home</router-link>
            <router-link class="footer__pages-link" to="/project">Project</router-link>
            <router-link class="footer__pages-link" to="/blog">Blog</router-link>
        </div>
        <div class="footer__contact">
            <h1 class="footer__contact-title">Contact</h1>
            <p class="footer__contact-address">55 East Birchwood Ave. Brooklyn, New York 11201</p>
            <p class="footer__contact-mail">contact@interno.com</p>
            <p class="footer__contact-phone">(123) 456 - 7890</p>
        </div>
    </div>
</template>
...
.footer {
    ...
    &__pages {
        ...
        &-title {
            @include font-dm(#292F36, 25px, 31.25px);
        }

        &-link {
            @include font-jost(#4D5053, 22px, 66px, 0.22px);
        }
    }
